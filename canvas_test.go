...
<image x="58" y="58" width="120" height="120" xlink:href="foo" />
<g style="font-size:23px;fill:#505050;text-anchor:middle">
<text x="118" y="39" >foo</text>
</g>
`)
}
...
func (s *CanvasSuite) TestRelationRender(c *gc.C) {
	...
	relation.usage(svg)
	c.Assert(buf.String(), gc.Equals,
		`<line x1="118" y1="236" x2="100" y2="218" stroke="#38B44A" stroke-width="2px" stroke-dasharray="2.73, 20" />
<use x="99" y="217" xlink:href="#healthCircle" />
`)
}
...
func (s *CanvasSuite) TestLayout(c *gc.C) {
	...
	c.Assert(width, gc.Equals, 336)
	c.Assert(height, gc.Equals, 336)
	canvas.addService(&service{
		point: image.Point{
			X: -100,
			Y: -100,
	...
	width, height = canvas.layout()
	c.Assert(width, gc.Equals, 536)
	c.Assert(height, gc.Equals, 436)
}
...
<g id="services">
<use x="0" y="0" xlink:href="#serviceBlock" />
<image x="58" y="58" width="120" height="120" xlink:href="" />
<g style="font-size:23px;fill:#505050;text-anchor:middle">
<text x="118" y="39" ></text>
</g>
<use x="100" y="100" xlink:href="#serviceBlock" />
<image x="158" y="158" width="120" height="120" xlink:href="" />
<g style="font-size:23px;fill:#505050;text-anchor:middle">
<text x="218" y="139" ></text>
</g>
</g>
</svg>
